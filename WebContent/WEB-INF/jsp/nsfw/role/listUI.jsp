...
<head>
	...
	function doSelectAll(){
  	...
  	//doAdd添加
  	function doAdd() {
  		window.location="${basePath}nsfw/role_addUI.action";
	}
  	//编辑
  	function doEdit(id) {
		document.forms[0].action="${bastPath}nsfw/role_updateUI.action?role.roleId="+id;
		document.forms[0].submit();
	}
  	
  	//删除
  	function doDelete(id) {
  		document.forms[0].action="${bastPath}nsfw/role_delete.action?role.roleId="+id;
		document.forms[0].submit();
	}
  	//批量删除
  	function doDeleteAll() {
  		document.forms[0].action="${bastPath}nsfw/role_deletes.action";
		document.forms[0].submit();
	}
    </script>
</head>
                    ...
                    <table width="100%" border="0">
                        <tr class="t_tit">
                            ...
                            <td width="120" align="center">操作</td>
                       		...
                       		<s:iterator status="st"  value="roleList">
