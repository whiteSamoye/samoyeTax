...
<head>
    ...
    <script type="text/javascript">
    	/* $(function() {
           	var wd = $(".WdateDiv");//WdateDiv  $("#selAll")
			wd.width("168");
    	}); */
    	...
    	function verifyAccount(ele) {
			...
			if(account != ""){
				$.ajax({
					...
					data:{"user.account":account,"user.id":"${user.id}"}, //注意ajax的data中可以直接通过el表达式进行取值
...
<form id="form" name="form" action="${basePath }nsfw/user_update.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:textfield id="birthday" name="user.birthday" readonly="true" onclick="myOnfocus()">
